...
void ofApp::update() {
    ...
    fftDevice.setThreshold(audioThreshold);
    fftDevice.setPeakDecay(audioPeakDecay);
    fftDevice.setMaxDecay(audioMaxDecay);
    fftDevice.setMirrorData(audioMirror);
    fftDevice.update();
    ...
    fftDevice.getFftPeakData(audioData, numOfVerts);
